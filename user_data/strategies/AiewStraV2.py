...
class AiewStraV2(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # MACD
        macd = ta.MACD(dataframe, window_slow=27,
                       window_fast=11, window_sign=4,)
        ...
        dataframe['ema11'] = ta.EMA(dataframe, timeperiod=11)
        dataframe['ema27'] = ta.EMA(dataframe, timeperiod=27)
        ...
        dataframe['sma4'] = ta.SMA(dataframe, timeperiod=4)
