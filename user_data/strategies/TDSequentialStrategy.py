...
class TDSequentialStrategy(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['seq_sell'] = dataframe['close'] > dataframe['close'].shift(
            4)
        ...
        for index, row in dataframe.iterrows():
            ...
            if seq_b > 8:
                ...
                if seq_b == 9:
                    dataframe.loc[index,
                                  'exceed_low'] = row['exceed_low'] | dataframe.loc[index-1, 'exceed_low']
            ...
            if seq_s > 8:
                ...
                if seq_s == 9:
                    dataframe.loc[index,
                                  'exceed_high'] = row['exceed_high'] | dataframe.loc[index-1, 'exceed_high']
