...
class Obelisk_Ichimoku_ZEMA_v1(IStrategy):
    ...
    zema_len_sell = IntParameter(
        30, 90, default=51, space='sell', optimize=True)
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            ...
            & (dataframe['close'] < (dataframe[zema] * self.low_offset.value)), 'buy'] = 1
        return dataframe
