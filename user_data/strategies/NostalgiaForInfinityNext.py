...
class NostalgiaForInfinityNext(IStrategy):
    ...
    buy_cti_1 = DecimalParameter(-0.99, -0.5, default=-0.92,
                                 space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_cti_3 = DecimalParameter(-0.99, -0.5, default=-0.5,
                                 space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_cti_4 = DecimalParameter(-0.99, -0.5, default=-0.8,
                                 space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_ema_rel_5 = DecimalParameter(
        0.97, 0.999, default=0.915, space='buy', decimals=3, optimize=False, load=True)
    buy_cti_5 = DecimalParameter(-0.99, -0.5, default=-0.84,
                                 space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_cti_7 = DecimalParameter(-0.99, -0.5, default=-0.89,
                                 space='buy', decimals=2, optimize=False, load=True)

    buy_cti_8 = DecimalParameter(-0.99, -0.5, default=-0.88,
                                 space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_ma_offset_9 = DecimalParameter(
        0.91, 0.94, default=0.968, space='buy', decimals=3, optimize=False, load=True)
    ...
    buy_ma_offset_10 = DecimalParameter(
        0.94, 0.99, default=0.98, space='buy', decimals=3, optimize=False, load=True)
    ...
    buy_rsi_1h_10 = DecimalParameter(
        30.0, 60.0, default=50.0, space='buy', decimals=1, optimize=False, load=True)

    buy_ma_offset_11 = DecimalParameter(
        0.93, 0.99, default=0.946, space='buy', decimals=3, optimize=False, load=True)
    ...
    buy_cti_12 = DecimalParameter(-0.99, -0.5, default=-0.7,
                                  space='buy', decimals=2, optimize=False, load=True)

    buy_ma_offset_13 = DecimalParameter(
        0.93, 0.98, default=0.99, space='buy', decimals=3, optimize=False, load=True)
    buy_cti_13 = DecimalParameter(-0.99, -0.5, default=-0.82,
                                  space='buy', decimals=2, optimize=False, load=True)
    buy_ewo_13 = DecimalParameter(-14.0, -7.0, default=-9.0,
    ...
    buy_cti_14 = DecimalParameter(-0.99, -0.5, default=-0.86,
                                  space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_ema_rel_15 = DecimalParameter(
        0.97, 0.999, default=0.974, space='buy', decimals=3, optimize=False, load=True)
    ...
    buy_cti_16 = DecimalParameter(-0.99, -0.5, default=-0.84,
                                  space='buy', decimals=2, optimize=False, load=True)

    buy_ma_offset_17 = DecimalParameter(
        0.93, 0.98, default=0.99, space='buy', decimals=3, optimize=False, load=True)
    buy_ewo_17 = DecimalParameter(-18.0, -10.0, default=-9.4,
                                  space='buy', decimals=1, optimize=False, load=True)
    buy_cti_17 = DecimalParameter(-0.99, -0.5, default=-0.96,
                                  space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_volume_18 = DecimalParameter(
        0.6, 6.0, default=2.0, space='buy', decimals=1, optimize=False, load=True)
    buy_cti_18 = DecimalParameter(-0.99, -0.5, default=-0.86,
                                  space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_cti_20 = DecimalParameter(-0.99, -0.5, default=-0.84,
                                  space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_cti_21 = DecimalParameter(-0.99, -0.4, default=-0.9,
                                  space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_ma_offset_22 = DecimalParameter(
        0.93, 0.98, default=0.942, space='buy', decimals=3, optimize=False, load=True)
    buy_ewo_22 = DecimalParameter(
        2.0, 10.0, default=5.8, space='buy', decimals=1, optimize=False, load=True)
    buy_rsi_22 = DecimalParameter(
        26.0, 56.0, default=36.0, space='buy', decimals=1, optimize=False, load=True)

    buy_bb_offset_23 = DecimalParameter(
        0.97, 1.0, default=0.985, space='buy', decimals=3, optimize=False, load=True)
    buy_ewo_23 = DecimalParameter(
        2.0, 10.0, default=6.2, space='buy', decimals=1, optimize=False, load=True)
    buy_rsi_23 = DecimalParameter(
        20.0, 40.0, default=32.4, space='buy', decimals=1, optimize=False, load=True)
    ...
    buy_25_cti = DecimalParameter(-0.99, -0.4, default=-0.76,
                                  space='buy', decimals=2, optimize=False, load=True)

    buy_26_zema_low_offset = DecimalParameter(
        0.90, 0.99, default=0.932, space='buy', optimize=False, load=True)
    buy_26_cti = DecimalParameter(-0.99, -0.4, default=-0.82,
                                  space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_27_wr_max = DecimalParameter(
        90, 99, default=90.0, space='buy', decimals=1, optimize=False, load=True)
    ...
    buy_27_cti = DecimalParameter(-0.99, -0.4, default=-0.93,
                                  space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_28_cti = DecimalParameter(-0.99, -0.4, default=-0.9,
                                  space='buy', decimals=2, optimize=False, load=True)

    buy_29_ma_offset = DecimalParameter(
        0.90, 0.99, default=0.94, space='buy', optimize=False, load=True)
    buy_29_ewo = DecimalParameter(-14.0, -2.0, default=-4.0,
                                  space='buy', decimals=1, optimize=False, load=True)
    buy_29_cti = DecimalParameter(-0.99, -0.4, default=-0.95,
                                  space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_30_cti = DecimalParameter(-0.99, -0.4, default=-0.88,
                                  space='buy', decimals=2, optimize=False, load=True)

    buy_31_ma_offset = DecimalParameter(
        0.90, 0.99, default=0.94, space='buy', optimize=False, load=True)
    buy_31_ewo = DecimalParameter(-22.0, -8.0, default=-19.0,
                                  space='buy', decimals=1, optimize=False, load=True)
    buy_31_wr = DecimalParameter(-99.9, -95.0, default=-98.4,
                                 space='buy', decimals=1, optimize=False, load=True)
    ...
    buy_32_cti = DecimalParameter(-0.99, -0.4, default=-0.8,
                                  space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_33_cti = DecimalParameter(-0.99, -0.4, default=-0.9,
                                  space='buy', decimals=2, optimize=False, load=True)
    ...
    buy_34_dip = DecimalParameter(
        0.001, 0.02, default=0.005, space='buy', decimals=3, optimize=False, load=True)
    buy_34_ewo = DecimalParameter(-24.0, -5.0, default=-6.0,
                                  space='buy', decimals=1, optimize=False, load=True)
    buy_34_cti = DecimalParameter(-0.99, -0.4, default=-0.88,
                                  space='buy', decimals=2, optimize=False, load=True)
    ...
    sell_custom_rsi_under_bull_0 = DecimalParameter(
    ...
    sell_custom_rsi_under_bull_1 = DecimalParameter(
    ...
    sell_custom_rsi_under_bull_2 = DecimalParameter(
    ...
    sell_custom_rsi_under_bull_3 = DecimalParameter(
    ...
    sell_custom_rsi_under_bull_4 = DecimalParameter(
    ...
    sell_custom_rsi_under_bull_5 = DecimalParameter(
    ...
    sell_custom_rsi_under_bull_6 = DecimalParameter(
    ...
    sell_custom_rsi_under_bull_7 = DecimalParameter(
    ...
    sell_custom_rsi_under_bull_8 = DecimalParameter(
    ...
    sell_custom_rsi_under_bull_9 = DecimalParameter(
    ...
    sell_custom_rsi_under_bull_10 = DecimalParameter(
    ...
    sell_custom_rsi_under_bull_11 = DecimalParameter(
        28.0, 40.0, default=30.0, space='sell', decimals=2, optimize=False, load=True)

    sell_custom_profit_bear_0 = DecimalParameter(
        0.01, 0.1, default=0.012, space='sell', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_0 = DecimalParameter(
        30.0, 40.0, default=34.0, space='sell', decimals=3, optimize=False, load=True)
    sell_custom_profit_bear_1 = DecimalParameter(
        0.01, 0.1, default=0.02, space='sell', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_1 = DecimalParameter(
        30.0, 50.0, default=35.0, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_2 = DecimalParameter(
        0.01, 0.1, default=0.03, space='sell', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_2 = DecimalParameter(
        30.0, 50.0, default=37.0, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_3 = DecimalParameter(
        0.01, 0.1, default=0.04, space='sell', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_3 = DecimalParameter(
        30.0, 50.0, default=44.0, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_4 = DecimalParameter(
        0.01, 0.1, default=0.05, space='sell', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_4 = DecimalParameter(
        35.0, 50.0, default=48.0, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_5 = DecimalParameter(
        0.01, 0.1, default=0.06, space='sell', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_5 = DecimalParameter(
        35.0, 50.0, default=50.0, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_rsi_over_bear_5 = DecimalParameter(
        70.0, 85.0, default=78.0, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_6 = DecimalParameter(
        0.01, 0.1, default=0.07, space='sell', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_6 = DecimalParameter(
        38.0, 55.0, default=52.0, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_rsi_over_bear_6 = DecimalParameter(
        70.0, 85.0, default=78.0, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_7 = DecimalParameter(
        0.01, 0.1, default=0.08, space='sell', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_7 = DecimalParameter(
        40.0, 58.0, default=54.0, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_rsi_over_bear_7 = DecimalParameter(
        70.0, 85.0, default=80.0, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_8 = DecimalParameter(
        0.06, 0.1, default=0.09, space='sell', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_8 = DecimalParameter(
        40.0, 50.0, default=52.0, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_rsi_over_bear_8 = DecimalParameter(
        70.0, 85.0, default=82.0, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_9 = DecimalParameter(
        0.05, 0.14, default=0.1, space='sell', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_9 = DecimalParameter(
        40.0, 60.0, default=50.0, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_10 = DecimalParameter(
        0.1, 0.14, default=0.12, space='sell', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_10 = DecimalParameter(
        38.0, 50.0, default=42.0, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_11 = DecimalParameter(
        0.16, 0.45, default=0.20, space='sell', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_11 = DecimalParameter(
        28.0, 40.0, default=30.0, space='sell', decimals=2, optimize=False, load=True)

    # Profit under EMA200
    sell_custom_under_profit_bull_0 = DecimalParameter(
        0.01, 0.4, default=0.01, space='sell', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bull_0 = DecimalParameter(
    ...
    sell_custom_under_rsi_under_bull_1 = DecimalParameter(
    ...
    sell_custom_under_rsi_under_bull_2 = DecimalParameter(
    ...
    sell_custom_under_rsi_under_bull_3 = DecimalParameter(
    ...
    sell_custom_under_rsi_under_bull_4 = DecimalParameter(
    ...
    sell_custom_under_rsi_under_bull_5 = DecimalParameter(
    ...
    sell_custom_under_rsi_under_bull_6 = DecimalParameter(
    ...
    sell_custom_under_rsi_under_bull_7 = DecimalParameter(
    ...
    sell_custom_under_rsi_under_bull_8 = DecimalParameter(
    ...
    sell_custom_under_rsi_under_bull_9 = DecimalParameter(
    ...
    sell_custom_under_rsi_under_bull_10 = DecimalParameter(
    ...
    def get_hold_trades_config_file():
        ...
        hold_trades_config_file_resolve = strat_file_path.resolve().parent / \
            "hold-trades.json"
        ...
        hold_trades_config_file_absolute = strat_file_path.absolute().parent / \
            "hold-trades.json"
    ...
    def load_hold_trades_config(self):
        ...
        with hold_trades_config_file.open('r') as f:
            ...
            try:
                ...
                log.error("Failed to load JSON from %s: %s",
                          hold_trades_config_file, exc)
            else:
    ...
    def custom_sell(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float,
        ...
        sell, signal_name = self.sell_recover(
            current_profit, last_candle, max_loss)
        if sell and (signal_name is not None):
            return signal_name + ' ( ' + buy_tag + ')'
    ...
    def informative_1h_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Ichimoku
        ichi = ichimoku(informative_1h, conversion_line_period=20,
                        base_line_periods=60, laggin_span=120, displacement=30)
        ...
        informative_1h['hl_pct_change_5'] = self.range_percent_change(
            informative_1h, 'HL', 5)
        informative_1h['low_5'] = informative_1h['low'].shift().rolling(
            5).min()
    ...
    def normal_tf_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        # BB 40 - STD2
        bb_40_std2 = qtpylib.bollinger_bands(
            dataframe['close'], window=40, stds=2)
        dataframe['bb40_2_low'] = bb_40_std2['lower']
        dataframe['bb40_2_mid'] = bb_40_std2['mid']
        dataframe['bb40_2_delta'] = (
            bb_40_std2['mid'] - dataframe['bb40_2_low']).abs()
        dataframe['closedelta'] = (
            dataframe['close'] - dataframe['close'].shift()).abs()
        dataframe['tail'] = (dataframe['close'] -
                             dataframe['bb40_2_low']).abs()
        ...
        # Stochastic RSI
        stochrsi = ta.STOCHRSI(dataframe, timeperiod=96,
        ...
        dataframe['source'] = (
            dataframe['high'] + dataframe['low'] + dataframe['open'] + dataframe['close'])/4
        ...
        dataframe['atr_high_thresh_1'] = (
            dataframe['high'] - (dataframe['atr'] * 5.4))
        dataframe['atr_high_thresh_2'] = (
            dataframe['high'] - (dataframe['atr'] * 5.2))
        dataframe['atr_high_thresh_3'] = (
            dataframe['high'] - (dataframe['atr'] * 5.0))
        dataframe['atr_high_thresh_4'] = (
            dataframe['high'] - (dataframe['atr'] * 2.0))
        dataframe['atr_high_thresh_q'] = (
            dataframe['high'] - (dataframe['atr'] * 3.0))
        ...
        dataframe['safe_dips_120'] = self.safe_dips(dataframe, self.buy_dip_threshold_120_1.value,
                                                    self.buy_dip_threshold_120_2.value, self.buy_dip_threshold_120_3.value, self.buy_dip_threshold_120_4.value)
        dataframe['safe_dips_130'] = self.safe_dips(dataframe, self.buy_dip_threshold_130_1.value,
                                                    self.buy_dip_threshold_130_2.value, self.buy_dip_threshold_130_3.value, self.buy_dip_threshold_130_4.value)

        # Volume
        dataframe['volume_mean_4'] = dataframe['volume'].rolling(
            4).mean().shift(1)
        ...
        if not self.config['runmode'].value in ('live', 'dry_run'):
            ...
            dataframe.loc[dataframe.index > (
                12 * 24 * self.bt_min_age_days), 'bt_agefilter_ok'] = True
        else:
            # Exchange downtime protection
            dataframe['live_data_ok'] = (dataframe['volume'].rolling(
                window=72, min_periods=72).min() > 0)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.info_timeframe != 'none':
            informative_1h = self.informative_1h_indicators(
                dataframe, metadata)
            dataframe = merge_informative_pair(
        ...
        for index in self.buy_protection_params:
            ...
            if self.buy_params['buy_condition_' + str(index) + '_enable']:
                ...
                if global_buy_protection_params["safe_dips"]:
                    item_buy_protection_list.append(
                        dataframe[f"safe_dips_{global_buy_protection_params['safe_dips_type']}"])
                if global_buy_protection_params["safe_pump"]:
                    item_buy_protection_list.append(
                        dataframe[f"safe_pump_{global_buy_protection_params['safe_pump_period']}_{global_buy_protection_params['safe_pump_type']}_1h"])
                ...
                if index == 1:
                    ...
                    # Logic
                    item_buy_logic.append(((dataframe['close'] - dataframe['open'].rolling(
                        36).min()) / dataframe['open'].rolling(36).min()) > self.buy_min_inc_1.value)
                    item_buy_logic.append(
                    ...
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_cti_1.value)
                ...
                # Condition #2
                    ...
                    # Logic
                    item_buy_logic.append(
                        dataframe['rsi_14'] < dataframe['rsi_14_1h'] - self.buy_rsi_1h_diff_2.value)
                    item_buy_logic.append(
                ...
                # Condition #3
                    ...
                    item_buy_logic.append(dataframe['close'].lt(
                        dataframe['bb40_2_low'].shift()))
                    item_buy_logic.append(
                        dataframe['close'].le(dataframe['close'].shift()))
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_cti_3.value)
                ...
                # Condition #4
                    ...
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_cti_4.value)
                ...
                # Condition #5
                    ...
                    item_buy_logic.append((dataframe['ema_26'].shift(
                    ) - dataframe['ema_12'].shift()) > (dataframe['open'] / 100))
                    item_buy_logic.append(dataframe['close'] < (
                        dataframe['bb20_2_low'] * self.buy_bb_offset_5.value))
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_cti_5.value)
                    item_buy_logic.append(dataframe['volume'] < (
                ...
                # Condition #7
                    ...
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_cti_7.value)
                ...
                # Condition #8
                    ...
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_cti_8.value)
                    item_buy_logic.append(dataframe['close'] < (
                ...
                # Condition #11
                    ...
                    # Logic
                    item_buy_logic.append(((dataframe['close'] - dataframe['open'].rolling(
                        36).min()) / dataframe['open'].rolling(36).min()) > self.buy_min_inc_11.value)
                    item_buy_logic.append(
                ...
                # Condition #12
                    ...
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_cti_12.value)
                ...
                # Condition #13
                    ...
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_cti_13.value)
                    item_buy_logic.append(
                ...
                # Condition #14
                    ...
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_cti_14.value)
                ...
                # Condition #16
                    ...
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_cti_16.value)
                ...
                # Condition #17
                    ...
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_cti_17.value)
                    item_buy_logic.append(dataframe['volume'] < (
                ...
                # Condition #18
                    ...
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_cti_18.value)
                ...
                # Condition #19
                    ...
                    # Logic
                    item_buy_logic.append(dataframe['close'].shift(
                        1) > dataframe['ema_100_1h'])
                    item_buy_logic.append(
                ...
                # Condition #20
                    ...
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_cti_20.value)
                    item_buy_logic.append(dataframe['volume'] < (
                ...
                # Condition #21
                    ...
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_cti_21.value)
                    item_buy_logic.append(dataframe['volume'] < (
                ...
                # Condition #23
                    ...
                    item_buy_logic.append(
                        dataframe['rsi_14'] < self.buy_rsi_23.value)
                    item_buy_logic.append(
                ...
                # Condition #24
                    ...
                    # Logic
                    item_buy_logic.append(dataframe['ema_12_1h'].shift(
                        12) < dataframe['ema_35_1h'].shift(12))
                    item_buy_logic.append(
                ...
                # Condition #26
                    ...
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_26_cti.value)
                    item_buy_logic.append(dataframe['volume'] < (
                ...
                # Condition #27
                    ...
                    item_buy_logic.append(
                        dataframe['rsi_14_1h'] + dataframe['rsi_14'] < self.buy_27_rsi_max.value)
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_27_cti.value)
                    item_buy_logic.append(dataframe['volume'] < (
                ...
                # Condition #28
                    ...
                    item_buy_logic.append(dataframe['moderi_64'] == True)
                    item_buy_logic.append(
                        dataframe['close'] < dataframe['hull_75'] * self.buy_28_ma_offset.value)
                    item_buy_logic.append(
                        dataframe['ewo'] > self.buy_28_ewo.value)
                    item_buy_logic.append(
                        dataframe['rsi_14'] < self.buy_28_rsi.value)
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_28_cti.value)
                ...
                # Condition #29
                    ...
                    item_buy_logic.append(dataframe['moderi_64'] == True)
                    item_buy_logic.append(
                        dataframe['close'] < dataframe['hull_75'] * self.buy_29_ma_offset.value)
                    item_buy_logic.append(
                        dataframe['ewo'] < self.buy_29_ewo.value)
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_29_cti.value)
                ...
                # Condition #30
                    ...
                    item_buy_logic.append(
                        dataframe['close'] < dataframe['zlema_68'] * self.buy_30_ma_offset.value)
                    item_buy_logic.append(
                        dataframe['ewo'] > self.buy_30_ewo.value)
                    item_buy_logic.append(
                        dataframe['rsi_14'] < self.buy_30_rsi.value)
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_30_cti.value)
                ...
                # Condition #31
                    ...
                    item_buy_logic.append(dataframe['moderi_64'] == False)
                    item_buy_logic.append(
                        dataframe['close'] < dataframe['zlema_68'] * self.buy_31_ma_offset.value)
                    item_buy_logic.append(
                        dataframe['ewo'] < self.buy_31_ewo.value)
                    item_buy_logic.append(
                        dataframe['r_480'] < self.buy_31_wr.value)
                ...
                # Condition #32 - Quick mode buy
                    ...
                    item_buy_logic.append(dataframe['moderi_96'])
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_32_cti.value)
                    item_buy_logic.append(
                        dataframe['rsi_20'] < dataframe['rsi_20'].shift(1))
                    item_buy_logic.append(
                        dataframe['rsi_4'] < self.buy_32_rsi.value)
                    item_buy_logic.append(
                        dataframe['ema_20_1h'] > dataframe['ema_25_1h'])
                    item_buy_logic.append(
                        (dataframe['open'] - dataframe['close']) / dataframe['close'] < self.buy_32_dip.value)
                    item_buy_logic.append(dataframe['close'] < (
                ...
                # Condition #33 - Quick mode buy
                    ...
                    item_buy_logic.append(dataframe['moderi_96'])
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_33_cti.value)
                    item_buy_logic.append(dataframe['close'] < (
                        dataframe['ema_13'] * self.buy_33_ma_offset.value))
                    item_buy_logic.append(
                        dataframe['ewo'] > self.buy_33_ewo.value)
                    item_buy_logic.append(
                        dataframe['rsi_14'] < self.buy_33_rsi.value)
                    item_buy_logic.append(dataframe['volume'] < (
                ...
                # Condition #34 - Quick mode buy
                    ...
                    # Logic
                    item_buy_logic.append(
                        dataframe['cti'] < self.buy_34_cti.value)
                    item_buy_logic.append(
                        (dataframe['open'] - dataframe['close']) / dataframe['close'] < self.buy_34_dip.value)
                    item_buy_logic.append(
                        dataframe['close'] < dataframe['ema_13'] * self.buy_34_ma_offset.value)
                    item_buy_logic.append(
                        dataframe['ewo'] < self.buy_34_ewo.value)
                    item_buy_logic.append(dataframe['volume'] < (
                ...
                # Condition #39 - Ichimoku
                    ...
                    item_buy_logic.append(
                        dataframe['chikou_span_1h'] > dataframe['senkou_a_1h'])
                    item_buy_logic.append(dataframe['efi_1h'] > 0)
                    item_buy_logic.append(
                        dataframe['ssl_up_1h'] > dataframe['ssl_down_1h'])
                    item_buy_logic.append(
                        dataframe['close'] < dataframe['ssl_up_1h'])
...
def vwma(dataframe: DataFrame, length: int = 10):
    ...
    vwma = Series(ta.SMA(pv, timeperiod=length) /
...
def moderi(dataframe: DataFrame, len_slow_ma: int = 32) -> Series:
    ...
    # we just need true & false for ERI trend
...
def hull(dataframe, timeperiod):
    if isinstance(dataframe, Series):
        ...
        return ta.WMA(
            2 * ta.WMA(dataframe['close'], int(math.floor(timeperiod/2))) - ta.WMA(
                dataframe['close'], timeperiod), int(round(np.sqrt(timeperiod)))
        )
...
def pmax(df, period, multiplier, length, MAtype, src):
    ...
    pmx = np.where((pm_arr > 0.00), np.where(
        (mavalue < pm_arr), 'down',  'up'), np.NaN)
...
def SSLChannels(dataframe, length=7):
    ...
    hlv = Series(np.where(dataframe['close'] > smaHigh, 1, np.where(
        dataframe['close'] < smaLow, -1, np.NAN)))
    hlv = hlv.ffill()
